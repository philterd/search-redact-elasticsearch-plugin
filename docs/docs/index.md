# Search Redact for Elasticsearch

Search Redact is an open source Elasticsearch plugin that redacts PII and PHI from search results at
query time, before they reach the user. It runs inside your Elasticsearch cluster and uses the
...
[GitHub](https://github.com/philterd/search-redact-elasticsearch-plugin). There is also a
[version for OpenSearch](https://github.com/philterd/search-redact-opensearch-plugin).
